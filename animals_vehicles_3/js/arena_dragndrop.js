  ...
  if (FLAG_DEBUG) {
    ...
    $("#coords").html(
      [
        ...
        "Orig: " +
          [
            parseInt(this.ox - board.centre[0] + params_vis.stimSize / 2),
            parseInt(this.oy - board.centre[1] + params_vis.stimSize / 2),
          ].join(", "),
        "Change: " + [dx, dy].join(", "),
        "Current: " +
          [
            parseInt(
              this.attr("x") - board.centre[0] + params_vis.stimSize / 2
            ),
            parseInt(
              this.attr("y") - board.centre[1] + params_vis.stimSize / 2
            ),
          ].join(", "),
