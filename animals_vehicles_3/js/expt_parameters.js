...
var FLAG_RANDOM = 1; // random agent provides responses on each trial (for final testing before expt goes live)
// subject data
var sdata;
// experiment data
var edata;
...
function setExperiment() {
  ...
  parameters.vericode = "68279FDA"; //TODO change this
...
function set_exemplar_ids() {
  ...
  return [
    ...
    arr.slice(
      parameters.nb_unique,
      parameters.nb_unique + parameters.nb_unique_test
    ),
  ];
}
