...
function ui_set_stimulus() {
  ...
  board.stimcanvas = new Raphael(window.innerWidth/2-300, window.innerHeight/2-300, 600,400)
  ...
  board.stimulus = board.stimcanvas.image(params_exp.stim_dir + stim.names[numbers.trial_count],10,10,580,380);
}
