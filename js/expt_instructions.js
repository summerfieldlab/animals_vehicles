...
*/
	...
	switch (parameters.domaincode){
		...
		// south orchard
		inStruct.txt[2]     = "And the second one is the <b>orange animal store</b>. <br>"
		inStruct.img[2]     =  "instr/instr_an_store_orange.png";
		
		// what to do
		inStruct.txt[3]     = "<b>The stores are located in different parts of the city.</b><br>Each store caters for a different customer base with unique preferences for certain features of the animals.<br> <b>Your task is to figure out what type of animals are preferred by customers of each store</b><<br> You do this by either accepting or rejecting animals for a given store, and observing the reward/penalty incurred by your choice.";
		inStruct.img[3]    = "";

		// trial - context
		inStruct.txt[4]     = "Each trial begins with an image of the store you're currently in.";
		inStruct.img[4]     = "instr/instr_an_store_blue.png";

		// trial - stimulus & mapping
		inStruct.txt[5]     = "Shortly after, you'll see an image of an animal, together with the key assignment for that trial.<br> To communicate your decision, you'll press either the <b>F</b> or <b>J</b> key (corresponding to the left and right side of the screen).<br> The key mapping changes randomly from trial to trial.<br><br> In the example below, you'll use the f key to reject and the j key to accept an animal."
		...
		inStruct.txt[7]     = "Right after you've pressed a button, we'll highlight your chosen option with a rectangle.<br>Let's assume that you decided to accept the animal."
		inStruct.img[7]     = "instr/instr_an_store_blue_accept.png";
		
		// trial - feedback 2
		inStruct.txt[8]    = "After a short delay, you'll receive your reward/penalty. <br>This indicates if your choice was good or bad.<br> If you've bought/accepted an animal that doesn't sell well, you'll receive a penalty<br>In contrast, if your chosen animal sells well, you'll receive a reward."
	...
	case 2:
		...
		// south orchard
		inStruct.txt[2]     = "And the second one is the <b>orange vehicle store</b>. <br>"
		...
		// trial - stimulus & mapping
		inStruct.txt[5]     = "Shortly after, you'll see an image of a vehicle, together with the key assignment for that trial.<br> To communicate your decision, you'll press either the <b>F</b> or <b>J</b> key (corresponding to the left and right side of the screen).<br> The key mapping changes randomly from trial to trial.<br><br> In the example below, you'll use the f key to reject and the j key to accept a vehicle."
		...
		// trial - decision & feedback 1
		inStruct.txt[7]     = "Right after you've pressed a button, we'll highlight your chosen option with a rectangle.<br>Let's assume that you decided to accept the vehicle."
		inStruct.img[7]     = "instr/instr_ve_store_blue_accept.png";
		
		// trial - feedback 2
		inStruct.txt[8]    = "After a short delay, you'll receive your reward/penalty. <br>This indicates if your choice was good or bad.<br> If you've bought/accepted a vehicle that doesn't sell well, you'll receive a penalty<br>In contrast, if your chosen vehicle sells well, you'll receive a reward."
		inStruct.img[8]    = "instr/instr_ve_store_blue_feedback.png";

		// trial - feedback 3
		inStruct.txt[9]    = "You'll see a number on either side of the vehicle. <br> These are the rewards/penalties. <br> You will always receive a reward of zero for rejecting a vehicle...";
		...
		// trial - feedback 5
		inStruct.txt[11]    = "Remember: You want to accept vehicles that give a reward, and reject vehicles that would incur a penalty. <br> In the example below, we should have rejected the vehicle.";
